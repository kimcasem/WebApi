USE [master]
GO
/****** Object:  Database [WebApi]    Script Date: 10/01/2025 3:35:05 pm ******/
CREATE DATABASE [WebApi]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'WebApi', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER02\MSSQL\DATA\WebApi.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'WebApi_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER02\MSSQL\DATA\WebApi_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [WebApi]
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 10/01/2025 3:35:05 pm ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 10/01/2025 3:35:05 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20250110035338_Initial Migration', N'6.0.1')
GO
SET IDENTITY_INSERT [dbo].[Users] ON 
GO
INSERT [dbo].[Users] ([Id], [Name], [EmailAddress], [Gender], [Birthdate], [Age]) VALUES (2, N'Jane Doe', N'janedoe@outlook.com', N'Female', N'1998-02-01', 27)
GO
